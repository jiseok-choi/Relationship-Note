...
class ReviseMoney extends Component {
    ...
    render() {
        return(
            <ButtonToolbar>
                <Button variant="primary"  onClick={() =>{console.log(this.props.visitInfo); this.setState({
                lgShow: true,
                ...
                <Modal.Body>
                    ...
                    <Form.Group as={Row} controlId="formName">
                        ...
                        <Col sm="10">
                        <Form.Control type="text" name="name" onChange={this.handleChange} defaultValue={this.props.visitInfo.name}/>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} controlId="formCelebration">
                        ...
                        <Col sm="10">
                        <Form.Control type="number" name="celebration" onChange={this.handleChange} defaultValue={this.props.visitInfo.celebration}/>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} controlId="formDate">
                        ...
                        <Col sm="10">
                        <Form.Control plaintext readOnly onChange={this.handleChange} defaultValue={moment(this.props.visitInfo.date).format('YYYY[년] MM[월] DD[일],  h[시] mm[분]')}/>
                        </Col>
                    </Form.Group>

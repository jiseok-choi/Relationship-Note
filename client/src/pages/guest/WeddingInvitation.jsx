...
class WeddingInvitation extends Component {
  ...
  album = images => {
    ...
    // const pictureImg = pictures.map(text => ({ src: `http://172.30.1.35:8000/${text}`}) )
    const temp =
      // [{ src: `http://172.30.1.35:8000/${this.state.mainPicture}`} ,{src: `http://172.30.1.35:8000/friend_img1572867145195.jpg` }]
      [{ src: "" }]
  ...
  render() {
    ...
    const images = [
      ...
      { src: `https://rnotestorage.s3.ap-northeast-2.amazonaws.com/friend_img1572867145195.jpg` }
    ]
    ...
    return (
      <>
        <Container align="center">
          ...
          <Card.Img
            variant="top"
            src={`https://rnotestorage.s3.ap-northeast-2.amazonaws.com/${this.state.mainPicture}`}
          />
          {/* </Card> */}
        ...
        <Container>
          <Card.Header align="center">초대의글</Card.Header>
          <br />
          <Col>
        ...
        <Container>
          <Card.Header align="center">사진첩</Card.Header>
          <br />
        ...
        <Container>
          <Card.Header align="center">오시는길</Card.Header>
          <br />

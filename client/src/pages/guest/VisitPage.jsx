...
class VisitPage extends Component {
    ...
    getVisit = () => {
        ...
        axios
            ...
            .get(`http://172.30.1.33:8000/visit/getVisit`, {
                params: {
    ...
    newVisit = (e) => {
        ...
        axios
            .post(`http://172.30.1.33:8000/visit/newVisit`, {
                data: {
        ...
        return (
            <div>
                ...
                <Card align='center' style={{ width: '15rem' }}>
                    <Card.Img variant="top"  src={`http://172.30.1.33:8000/${this.state.picture}`} />
                </Card>
                ...
                <Form>
                    ...
                    <Form.Group as={Row} controlId="formHorizontalName">
                        ...
                        <Col sm={9}>
                        <Form.Control type="text" name="name" placeholder="홍길동" onChange={this.handleChange}/>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} controlId="formHorizontalContents">
                        ...
                        <Col sm={9}>
                        <Form.Control as="textarea" type="text" name="contents" placeholder="축하합니다" onChange={this.handleChange}/>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} controlId="formHorizontalCelebration">
                        ...
                        <Col sm={9}>
                        <Form.Control type="number" name="celebration" placeholder="방명록 대장에 보이지 않습니다" onChange={this.handleChange}/>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} controlId="formHorizontalPassword">
                        ...
                        <Col sm={9}>
                        <Form.Control type="password" name="password" placeholder="1234" onChange={this.handleChange}/>
                        </Col>
                    </Form.Group>
